...
import "../assets/styles/page-404.css"
...
function Error ({code=404, message=""}) {
    ...
    return <Layout>
        <div className="PageError">
            <svg width="198" height="99" viewBox="0 0 598 263" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {code === 404 ? (
                <p className="PageError__text">Oups! La page que vous demandez n&apos;existe pas.</p>
            ) : (
                <div className="PageError__text">
                    Une erreur est survenue
                    {code && (
                        <p>
                            {"code de l&quote;erreur : "+code}
                        </p>
                    )}
                    {message && (
                        <p>{message}</p>
            ...
            <NavLink to='/' className="pageError__linkHome">Retourner sur la page d’accueil</NavLink>
        </div>
   </Layout>
}
